...
export const TileWrapper: React.FC<WrapperProps> = ({
    ...
    return (
        <TileContext.Provider value={{ numOfPages, currentPage }}>
            <div ref={refContainer} className='relative bg-base-100' style={{
...
export const TileBackground: React.FC<Proops> = ({ children }) => (
    <div className='absolute h-full w-full'>{children}</div>
)

export const TileContent: React.FC<Proops> = ({ children }) => (
